VulnHub BlueMoon 2021 Machine Walkthrough
...
At this stage, I already gained access to the machine as user jerry, but I still did not have root privileges.
To continue the privilege escalation process, I first upgraded the shell to make it more interactive.
